...
def parse_args():
    ...
    parser.add_argument(
        '--output_csv_df', help='Enter the name you want to use for the csv formatted output dataframe. For example: "gila_big_dataframe.html". ')
...
# gifted from stackexchange user:_______ Credit<-----
...
def main():
    ...
    big_df = big_df.drop({'G_10_dna.gila1.mkdup.sorted.bam','G_16_dna.gila1.mkdup.sorted.bam', 'G_30_dna.gila1.mkdup.sorted.bam', 'G_35_dna.gila1.mkdup.sorted.bam', 'G_KI01_dna.gila1.mkdup.sorted.bam', 'G_L_dna.gila1.mkdup.sorted.bam'}, axis = 1)
